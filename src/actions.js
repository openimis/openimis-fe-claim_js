...
export function fetchClaim(mm, claimUuid, forFeedback) {
  ...
  if (!!forFeedback) {
    ...
    projections.push(
      "services{" +
        "id, product { id, uuid }, service {id code name price manualPrice maximumAmount packagetype} qtyProvided,  priceAsked, qtyApproved, priceApproved, priceValuated,priceAdjusted, explanation, justification, rejectionReason, status," +
